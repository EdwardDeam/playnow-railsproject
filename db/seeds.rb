...
regular1 = User.create({ :email => 'user1@test.com', username: Faker::TvShows::AquaTeenHungerForce.character, :first_name => 'Harry', :last_name => 'Smith', :password => 'qwert123', :password_confirmation => 'qwert123', :seller => false})
regular2 = User.create({ :email => 'user2@test.com', username: Faker::TvShows::AquaTeenHungerForce.character, :first_name => 'Anna', :last_name => 'Jones', :password => 'qwert123', :password_confirmation => 'qwert123', :seller => false})
regular3 = User.create({ :email => 'user3@test.com', username: Faker::TvShows::AquaTeenHungerForce.character, :first_name => 'John', :last_name => 'Doe', :password => 'qwert123', :password_confirmation => 'qwert123', :seller => false})
...
pub1 = User.create({ :email => 'pub1@test.com', username: Faker::TvShows::AquaTeenHungerForce.character, :first_name => 'William', :last_name => 'Fence', :password => 'qwert123', :password_confirmation => 'qwert123', :seller => true})
pub2 = User.create({ :email => 'pub2@test.com', username: Faker::TvShows::AquaTeenHungerForce.character, :first_name => 'William', :last_name => 'Chris', :password => 'qwert123', :password_confirmation => 'qwert123', :seller => true})
